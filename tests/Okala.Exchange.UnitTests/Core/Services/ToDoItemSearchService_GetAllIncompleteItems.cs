...
using Okala.Exchange.Core.ProjectAggregate;
using Okala.Exchange.Core.Services;
using Okala.Exchange.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace Okala.Exchange.UnitTests.Core.Services
{
